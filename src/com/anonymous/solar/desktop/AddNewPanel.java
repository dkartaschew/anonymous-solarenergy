...
public class AddNewPanel extends javax.swing.JDialog {
	 ...
	 * 
	 * for (SolarPanel pan : panelData) { JOptionPane.showMessageDialog(this,
	 * pan.getPanelName()); }
	 */
	...
	private void initComponents() {
		...
		jPanelDataGroup.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Panel Data"));
		...
		jSpinnerWattage.setModel(new javax.swing.SpinnerNumberModel(100.0d,
				0.0d, 1000.0d, 5.0d));

		jSpinnerCost.setModel(new javax.swing.SpinnerNumberModel(0.0d, 0.0d,
				25000.0d, 10.0d));

		jSpinnerRRP.setModel(new javax.swing.SpinnerNumberModel(0.0d, 0.0d,
				25000.0d, 10.0d));

		jSpinnerEfficiency.setModel(new javax.swing.SpinnerNumberModel(0.0d,
				0.0d, 100.0d, 1.0d));

		javax.swing.GroupLayout jPanelDataGroupLayout = new javax.swing.GroupLayout(
				jPanelDataGroup);
		jPanelDataGroup.setLayout(jPanelDataGroupLayout);
		jPanelDataGroupLayout
				.setHorizontalGroup(jPanelDataGroupLayout
						.createParallelGroup(
						...
						.addGroup(
								jPanelDataGroupLayout
										...
										.addContainerGap(
												...
												Short.MAX_VALUE)));
		jPanelDataGroupLayout
				.setVerticalGroup(jPanelDataGroupLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								jPanelDataGroupLayout
		...
		jPanelPanelLocationGroup.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Location Data"));
		...
		jSpinnerPanelCount.setModel(new javax.swing.SpinnerNumberModel(0, 0,
				100, 5));

		jSpinnerAzimuth.setModel(new javax.swing.SpinnerNumberModel(0.0d,
				-180.0d, 180.0d, 1.0d));

		jSpinnerDirection.setModel(new javax.swing.SpinnerNumberModel(0.0d,
				0.0d, 359.0d, 10.0d));

		javax.swing.GroupLayout jPanelPanelLocationGroupLayout = new javax.swing.GroupLayout(
				jPanelPanelLocationGroup);
		jPanelPanelLocationGroup.setLayout(jPanelPanelLocationGroupLayout);
		jPanelPanelLocationGroupLayout
				.setHorizontalGroup(jPanelPanelLocationGroupLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								jPanelPanelLocationGroupLayout
										...
										.addContainerGap()));
		jPanelPanelLocationGroupLayout
				.setVerticalGroup(jPanelPanelLocationGroupLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								jPanelPanelLocationGroupLayout
		...
		jPanel1.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Stored Panels"));
		...
		layout.setVerticalGroup(layout
				...
				.addGroup(
						...
						layout.createSequentialGroup()
								...
								.addPreferredGap(
										javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jPanelDataGroup,
										javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(
										javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jPanelPanelLocationGroup,
										javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(
	...
	private SolarPanel getVerifiedPanel() throws Exception {
		...
		boolean error = false;
		javax.swing.border.LineBorder borderError = new javax.swing.border.LineBorder(
				Color.red, 3);
		...
		panel.setPanelLossYear((Double) jSpinnerEfficiency.getModel()
				.getValue());
	...
	private void LoadPanels(SolarPanels oldPanels) {
		...
		if (oldPanels != null) {
			...
			txtManufacturer.setText(oldPanels.getPanelType()
					.getPanelManufacturer());
			txtCode.setText(oldPanels.getPanelType().getPanelManufacturerCode());
			jSpinnerWattage
					.setValue(oldPanels.getPanelType().getPanelWattage());
			...
			jSpinnerEfficiency.setValue(oldPanels.getPanelType()
					.getPanelLossYear());
	...
	private void returnToWhite() {
		javax.swing.border.LineBorder clear = new javax.swing.border.LineBorder(
				Color.white, 0);
	...
	private boolean submitPanelData() {
		...
		try {
			...
			// Generate Panel(s)
			newPanels = new SolarPanels(panel, panelCount, panelDirection,
					panelAzimuth);
