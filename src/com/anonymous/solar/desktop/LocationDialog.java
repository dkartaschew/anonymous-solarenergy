...
public class LocationDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButtonOK.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/anonymous/solar/desktop/images/dialog-ok.png"))); // NOI18N
        ...
        jPanelDefinedLocationLayout.setHorizontalGroup(
            jPanelDefinedLocationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelDefinedLocationLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelLocationName)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jComboBoxLocationName, 0, 183, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanelDefinedLocationLayout.setVerticalGroup(
            jPanelDefinedLocationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelDefinedLocationLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanelDefinedLocationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jComboBoxLocationName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelLocationName))
        ...
        jTableWeatherDetails.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Jan", null, null},
                {"Feb", null, null},
                {"Mar", null, null},
            ...
            new String [] {
                "Month", "Cloudy Days", "Efficiency Loss"
            }
        ) {
        ...
        jPanelLocationDetailsLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelLocationDetailsLayout.createSequentialGroup()
                ...
                .addGroup(jPanelLocationDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelLocationDetailsLayout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
        ...
        jPanelLocationDetailsLayout.setVerticalGroup(
            ...
            .addGroup(jPanelLocationDetailsLayout.createSequentialGroup()
                ...
                .addGroup(jPanelLocationDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextFieldLocationName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelLocationNameR))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanelLocationDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jLabelMapInstructions.setFont(jLabelMapInstructions.getFont().deriveFont(jLabelMapInstructions.getFont().getSize()-2f));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPanelLocationDetails, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jPanelDefinedLocation, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jMapViewer1, javax.swing.GroupLayout.PREFERRED_SIZE, 481, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabelMapInstructions)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabelViewMode)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jComboBoxTileLoadSelector, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jPanelDefinedLocation, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanelLocationDetails, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jMapViewer1, javax.swing.GroupLayout.DEFAULT_SIZE, 448, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOKActionPerformed
        ...
        if (success) {
            //((Wizard)parent).getSolarSetup().setLocation(locationData);
            this.setVisible(false);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "alert", "Information not valid or present", JOptionPane.WARNING_MESSAGE);
    ...
    private void SetupMapSelectionComboBox() {
        ...
        //jComboBoxTileLoadSelector.addItem((TileSource) new OsmTileSource.TilesAtHome());
    ...
    private void SetupTable() {
        jTableWeatherDetails.setFont(jTableWeatherDetails.getFont().deriveFont(jTableWeatherDetails.getFont().getStyle(), jTableWeatherDetails.getFont().getSize() - 1));
        jTableWeatherDetails.getTableHeader().setFont(jTableWeatherDetails.getFont().deriveFont(jTableWeatherDetails.getFont().getStyle(), jTableWeatherDetails.getFont().getSize() - 1));
