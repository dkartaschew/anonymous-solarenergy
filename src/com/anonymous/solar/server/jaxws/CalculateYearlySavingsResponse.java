...
@XmlRootElement(name = "calculateYearlySavingsResponse", namespace = "http://server.solar.anonymous.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "calculateYearlySavingsResponse", namespace = "http://server.solar.anonymous.com/")
