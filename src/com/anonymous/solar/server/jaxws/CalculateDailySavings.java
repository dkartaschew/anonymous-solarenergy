...
@XmlRootElement(name = "calculateDailySavings", namespace = "http://server.solar.anonymous.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "calculateDailySavings", namespace = "http://server.solar.anonymous.com/", propOrder = {
    "arg0",
    "arg1"
})
public class CalculateDailySavings {
