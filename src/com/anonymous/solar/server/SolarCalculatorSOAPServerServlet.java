...
/**
 * This class is a servlet that handles the SOAP requests server side.
 * 
...
public class SolarCalculatorSOAPServerServlet extends HttpServlet {

	static MessageFactory messageFactory;
	static SolarCalculatorSOAPHandler soapHandler;
	
	static {
		try {
			messageFactory = MessageFactory.newInstance();
			soapHandler = new SolarCalculatorSOAPHandler();
		} catch (Exception ex) {
